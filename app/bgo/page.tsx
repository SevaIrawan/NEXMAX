      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Business Growth Optimization dashboard and analytics platform is currently under development.
          </p>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontSize: '14px', fontWeight: '600', color: '#374151' }}>Growth</span>
            </div>
            <div style={{
              background: '#f8fafc',
              padding: '16px',
