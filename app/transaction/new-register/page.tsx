      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            New user registration management and analytics dashboard is currently under development.
          </p>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontSize: '14px', fontWeight: '600', color: '#374151' }}>Registration</span>
            </div>
            <div style={{
              background: '#f8fafc',
              padding: '16px',
