      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Executive Operations and Optimization dashboard and analytics platform is currently under development.
          </p>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontSize: '14px', fontWeight: '600', color: '#374151' }}>Operations</span>
            </div>
            <div style={{
              background: '#f8fafc',
              padding: '16px',
              ...
              <span style={{ fontSize: '20px' }}>🎯</span>
              <span style={{ fontSize: '14px', fontWeight: '600', color: '#374151' }}>Optimization</span>
            </div>
            <div style={{
              background: '#f8fafc',
              padding: '16px',
